...
|     | **Sessions**   |                                   |      |             |                                         |                                                                            |
| 8   | POST           | `/api/sessions`                   | -    | -           | -                                       | {locationId, groupId?, name}                                               |
| 9   | GET            | `/api/sessions`                   | -    | -           | {groupId?, locationId?, status?, name?} | -                                                                          |
| 10  | GET            | `/api/sessions/:id`               | -    | sessionId   | -                                       | -                                                                          |
| 11  | PATCH          | `/api/sessions/:id`               | y    | sessionId   | -                                       | {status, locationId?, groupId?, name?, startTime?, endTime?, pricingId?}   |
| 12  | DELETE         | `/api/sessions/:id`               | y    | sessionId   | -                                       | -                                                                          |
| 13  | PATCH          | `/api/sessions/groups/:id`        | y    | groupId     | -                                       | {status, locationId?, name?, startTime?, endTime?, pricingId?}             |
|     | **Orders**     |                                   |      |             |                                         |                                                                            |
| 14  | POST           | `/api/orders/preview`             | y    | -           | -                                       | {sessionIds[]}                                                             |
| 15  | POST           | `/api/orders`                     | y    | -           | -                                       | {sessionIds[], discount}                                                   |
| 16  | GET            | `/api/orders`                     | y    | -           | {status?, page?}                        | -                                                                          |
| 17  | GET            | `/api/orders/:id`                 | y    | orderId     | -                                       | -                                                                          |
| 18  | PATCH          | `/api/orders/:id`                 | y    | orderId     | -                                       | {status}                                                                   |
...
|     | **Pricing**    |                                   |      |             |                                         |                                                                            |
| 24  | POST           | `/api/pricings`                    | y    | -           | -                                       | {name, billingIntervalMin, roundingMethod, price, unitId, currencyId} |
| 25  | GET            | `/api/pricings`                    | y    | -           | -                                       | -                                                                          |
| 26  | PATCH          | `/api/pricings/:id`                | y    | pricingId   | -                                       | {name, billingIntervalMin, roundingMethod, price, unitId, currencyId} |
